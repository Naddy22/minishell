...
/*   Updated: 2024/05/09 10:46:15 by vboulang         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	execution(t_cmd cmd, char **argv, char **envp)
{
	...
	test[0] = ft_calloc(5, sizeof(char));
	test[0] = "nano";
	test[1] = ft_calloc(6, sizeof(char));
	test[1] = "zallo";
	test[2] = ft_calloc(8, sizeof(char));
	test[2] = "bandana";
